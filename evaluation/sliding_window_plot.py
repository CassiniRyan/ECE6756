...
def plot_sliding_window(logs, window, output):
    ...
    for i, (task, path) in enumerate(logs):
        ...
        episodes, averaged = sliding_average(rewards, window)
    ...
    ax.set_title("Sliding-Window Training Reward")
...
def main():
    ...
    plot_sliding_window(logs, args.window, args.output)
